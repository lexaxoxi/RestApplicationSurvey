...
@Api(
        ...
        description="Контроллер предоставляет операции над сущностями \"Опроса\""
)
@Slf4j
    ...
    public SurveyDetail create(
            @ApiParam(
                    ...
                    value = "Модель сущности \"Опрос\" <br/>" +
                            ...
                            "{\n" +
                            "    \"name\": \"Опрос по благоустройству территории\",\n" +
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    message = "Операция выполнена успешно <br />" +
                            ...
                            "  {\n" +
                            "    \"uid\": 2,\n" +
                            "    \"name\": \"Опрос по подготовке к школе\",\n" +
                            "    \"start_date\": \"2021-09-01\",\n" +
                            "    \"finish_date\": \"2021-11-21\",\n" +
                            "    \"relevance\": true\n" +
                            "  }\n" +
                            "]",
                    response = SurveyDetail.class,
