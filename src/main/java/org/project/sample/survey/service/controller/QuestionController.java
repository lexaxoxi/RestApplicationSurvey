...
@Api(
        ...
        description="Контроллер предоставляет операции над сущностями \"Вопрос опроса\""
)
@Slf4j
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    message = "Операция выполнена успешно <br />" +
                            ...
                            "  \"survey_uid\": 6,\n" +
                            "  \"number\": 1,\n" +
                            "  \"text\": \"Какой парк необходимо расширить?\"\n" +
                            "}",
    ...
    @ApiResponses(value = {
            @ApiResponse(
                    ...
                    message = "Операция выполнена успешно <br />" +
                            ...
                            "    \"survey_uid\": 1,\n" +
                            "    \"number\": 2,\n" +
                            "    \"text\": \"Хватает ли парковочных мест?\"\n" +
                            "  },\n" +
                            "  {\n" +
                            "    \"uid\": 4,\n" +
                            "    \"survey_uid\": 6,\n" +
                            "    \"number\": 1,\n" +
                            "    \"text\": \"Хватает ли детских площадок?\"\n" +
                            "  }\n" +
                            "]",
                    response = QuestionDetail.class,
    ...
    public List<QuestionDetail> find(
            @ApiParam(
                    ...
                    value = "Модель сущности \"Вопрос опроса\" <br/>" +
                            ...
                            "{} <br />" +
                            "<b> 2 -  Для вывода первых двух сущностей </b><br />" +
                            "{\"search_filter\": {\n" +
                            "    \"fields\": \"uid\",\n" +
                            "    \"number\": 0,\n" +
                            "    \"direction\": \"ASC\",\n" +
